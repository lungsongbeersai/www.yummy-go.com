...
export function useStoreBranchLabels(): StoreBranchLabels {
  ...
  return {
    ...
    depositExpireDays: t("settings.storeBranch.depositExpireDays"),
    depositExpireDaysHint: t("settings.storeBranch.depositExpireDaysHint"),
    depositExpireDaysPlaceholder: t("settings.storeBranch.depositExpireDaysPlaceholder"),
    email: t("fields.email"),
    emailPlaceholder: t("settings.emailPlaceholder"),
    general: t("settings.storeBranch.general"),
    hasTables: t("settings.storeBranch.hasTables"),
    ...
    noTables: t("settings.storeBranch.noTables"),
    offlineMobileEnabled: t("settings.storeBranch.offlineMobileEnabled"),
    offlineMobileEnabledHint: t("settings.storeBranch.offlineMobileEnabledHint"),
    offlineMobileToggleFailed: t("settings.storeBranch.offlineMobileToggleFailed"),
    ...
    tableStatus: t("settings.storeBranch.tableStatus"),
    tableStatusHint: t("settings.storeBranch.tableStatusHint"),

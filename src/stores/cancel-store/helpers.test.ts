...
describe("cancel store helpers", () => {
  ...
  it("normalizes cancelled bill history without dropping cancel and payment fields", () => {
        ...
        data: [
          {
            ...
            order_cancelled_by: "906b77f7-7131-4484-8571-f346c1f95fa7",
            order_cancelled_by_name: "manager@yummy-go.com",
    ...
    expect(normalized.historyBills[0]).toMatchObject({
      ...
      cancelledBy: "906b77f7-7131-4484-8571-f346c1f95fa7",
      cancelledByName: "manager@yummy-go.com",
      discountAmount: 0,
      grandTotal: 1225846,
      invoice: "030626-0001",
      orderQty: 9,
